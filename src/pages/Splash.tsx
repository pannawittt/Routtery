import image_logo_3 from '@/imports/logo-3.png'
import image_logo_1 from '@/imports/logo-1.png'
import splashBg from '@/imports/splash-bg.jpg'
  ...
  return (
    <div className="min-h-screen w-full bg-[#FFFDF5] flex flex-col lg:flex-row overflow-hidden">
      ...
      <div className="w-full lg:w-[55%] h-[45vh] lg:h-screen bg-[#FFF1D0] relative overflow-hidden flex-shrink-0 border-b-2 lg:border-b-0 lg:border-r-2 border-[#1A1207]">
        <img src={splashBg} alt="Bangkok Canal" className="w-full h-full object-cover" />
        <div className="absolute top-5 left-5 hidden lg:block">
          <div
            className="bg-[#FFFDF5] border-2 border-[#1A1207] px-4 py-2 rounded-full"
            style={{ boxShadow: "3px 3px 0 #1A1207" }}
          >
            <img src={image_logo_3} alt="Routtery" className="h-7" />
          </div>
        </div>
        {/* Mode badges */}
        ...
        <div className="max-w-md w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-8">
            <PrimaryButton
              ...
              className="bg-[#00754B] text-base px-8 py-4 flex items-center justify-center gap-2 flex-1 sm:flex-none "
            >
