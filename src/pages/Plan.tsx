  ...
  return (
    <div className="min-h-screen w-full bg-[#FFFDF5]">
      <div className="max-w-[640px] mx-auto px-6 py-10">
        <h2 className="font-['Anuphan'] text-3xl md:text-4xl font-bold text-[#1A1207] mb-1">{t.plan.title}</h2>
        <p className="font-['Bai_Jamjuree'] text-[#1A1207]/55 mb-8 text-sm">{t.plan.subtitle}</p>

        {/* Origin — required */}
        <div className="mb-8">
          <label className="font-['Anuphan'] text-sm text-[#E8340A] mb-2 block">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-10 pr-10 py-4 font-['Bai_Jamjuree'] border-2 border-[#1A1207] rounded-full bg-white focus:outline-none focus:ring-2 focus:ring-[#E8340A]/30 text-[#1A1207] appearance-none cursor-pointer"
          ...
          {originId === null && (
            <p className="font-['Bai_Jamjuree'] text-xs text-[#E8340A]/70 mt-2 ml-4">{t.plan.origin_required}</p>
          )}
        </div>

        {/* Mode Selection — required */}
        <div className="mb-8">
          <label className="font-['Anuphan'] text-sm text-[#E8340A] mb-3 block">
          ...
          <div className="space-y-3">
            {(Object.entries(modeConfig) as [Mode, typeof modeConfig[Mode]][]).map(([key, m]) => (
              ...
              >
                ...
                <span className="font-['Anuphan'] text-base font-bold flex-1 text-left">{modeLabel(key)}</span>
        ...
        <div className="mt-10 pb-4">
          ...
          {!canProceed && (
            <p className="font-['Bai_Jamjuree'] text-center text-xs text-[#1A1207]/40 mt-3">
